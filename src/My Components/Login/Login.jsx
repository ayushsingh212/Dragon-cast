...
const Login = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-purple-700 to-cyan-600 dark:bg-gradient-to-br dark:from-black dark:to-gray-800 bg-cover bg-no-repeat relative">
