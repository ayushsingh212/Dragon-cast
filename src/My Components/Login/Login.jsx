...
const Login = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center dark:from-black dark:to-gray-800  bg-[url('./assets/loginwlcm.png')]  bg-contain bg-center  relative">
